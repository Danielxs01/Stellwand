...
public class BlockAsphaltLTtoRC extends Block {

	private IIcon[] tops = new IIcon[4];
	private IIcon side = null;

	public static final String FULLTEXTURENAME = Constants.MODID + ":" + "asphaltLTtoRC/asphalt";

	private static final int TOP = 1;

	protected BlockAsphaltLTtoRC() {
	...
	public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List<String> par3List,
			boolean par4) {
		par3List.add("Asphalt Block");
		par3List.add("From left top to right center");
	}
