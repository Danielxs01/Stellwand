...
public class BlockTrackDiagDR extends BlockSignal implements IStellwandBlock {
	...
	public static final String PATH = Constants.MODID + ":" + "stellwand/trackDiag/block_track_diag_dr_";
