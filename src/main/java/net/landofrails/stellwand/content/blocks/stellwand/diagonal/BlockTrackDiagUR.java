package net.landofrails.stellwand.content.blocks.stellwand.diagonal;
...
public class BlockTrackDiagUR extends BlockSignal implements IStellwandBlock {
	...
	public static final String PATH = Constants.MODID + ":" + "stellwand/trackDiag/block_track_diag_ur_";
