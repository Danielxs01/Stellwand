...
public class OpenGUI implements IMessage {
	...
	public OpenGUI(int guiId, BlockPos pos, int frequency, EStellwandSignal signal) {
		this.guiId = guiId;
		this.pos = pos;
	...
	public static class Handler extends AbstractClientMessageHandler<OpenGUI> {
		...
		public IMessage handleClientMessage(EntityPlayer player, OpenGUI message, MessageContext ctx) {
			...
			player.openGui(LandOfRails.instance, message.guiId, player.worldObj, pos.getX(), pos.getY(), pos.getZ());
			return null;
		}
